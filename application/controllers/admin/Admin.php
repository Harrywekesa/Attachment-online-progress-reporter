...
class Admin extends Admin_Controller
{
    ...
    public function dashboard()
    {
        ...
        $tot_students = $this->studentsession_model->getTotalStudents();
        $data['tot_students'] = $tot_students;
        ...
        if (!empty($tot_students)) {
            $data['total_students1'] = $tot_students->total_student;
        }
...
//        $this->db->update('sch_settings', array('session_id'=>$session));
