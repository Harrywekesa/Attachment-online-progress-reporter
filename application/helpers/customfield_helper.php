...
if (!function_exists('display_custom_fields')) {
    ...
    function render_select_field($name, $belong_to, $field_id, $validation, $options, $label = '', $value = '', $type = 'text', $input_class = '')
    {
    ...
    function render_multiselect_field($name, $belong_to, $field_id, $validation, $options, $label = '', $value = '', $type = 'text', $input_class = '')
    {
        $input            = '';
        $_form_group_attr = '';
        $_input_attrs     = '';
    ...
    function render_checkbox_field($name, $belong_to, $field_id, $validation, $options, $label = '', $value = '', $type = 'text', $input_class = '')
    {
