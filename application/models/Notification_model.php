...
class Notification_model extends MY_Model {
    ...
    public function getUnreadStudentNotification($student_id) {


        $sql = "select send_notification.* from send_notification  left JOIN read_notification on  read_notification.student_id=".$student_id." and read_notification.notification_id = send_notification.id WHERE  send_notification.visible_student='yes' and read_notification.id IS NULL  group by send_notification.id order by send_notification.id desc";
        $query = $this->db->query($sql);
        return $query->result();
    }
