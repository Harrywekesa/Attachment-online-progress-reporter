...
<?php $total_students = ($total_students > 0)?$total_students:1;?>
<style type="text/css">
                            ...
                            <div class="info-box">
                                <a href="<?php echo site_url('student/search') ?>">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Total <?php echo $this->lang->line('student'); ?></span>
                                        <span class="info-box-number"><?php echo $total_students1; ?></span>
                                    </div>
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="info-box">
                                        <a href="<?php echo site_url('studentfee') ?>">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text">Student On Attachment</span>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="info-box">
                                        <a href="<?php echo site_url('admin/expense') ?>">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text">Attachment Companies</span>
