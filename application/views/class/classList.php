                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="department" class="form-control" id="department">
                                        ...
                                        <option value="<?php echo $depts['id']; ?>"><?php echo $depts['department_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    foreach ($sections as $section) {
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="sections[]" value="<?php echo $section['id'] ?>" <?php echo set_checkbox('sections[]', $section['id']); ?> ><?php echo $section['section'] ?>
                                            </label>
                                        </div>
                                        <?php
                                    }
                                ...
                                <tbody>
                                    ...
                                    foreach ($vehroutelist as $vehroute) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <?php echo $this->db->get_where('department', array('id'=>$vehroute->department))->row()->department_name; ?>
