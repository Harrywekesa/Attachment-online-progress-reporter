<ul class="sessionul fixedmenu">
    ...
    if ($this->rbac->hasPrivilege('quick_session_change', 'can_view')) {
        ...
        <li class="removehover">
            <a data-toggle="modal" data-target="#sessionModal"><span><?php echo $this->lang->line('current_session'); ?></span><i class="fa fa-pencil pull-right"></i></a>


        </li>
        <li style="color: #0acffe;">
