                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="relative">   
                                            ...
                                            <h4 class="session-head"><?php echo $this->lang->line('mobile_app'); ?>
                                                <?php if ($app_ver) { echo "<small class=' alert-success'>(".$this->lang->line('android_app_purchase_code_already_registered').")</small>"; } ?></h4>
