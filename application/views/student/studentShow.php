            ...
            <div class="col-md-12">
                <section class="content-header" style="padding-right: 0;">
                    <h1>
                        ...
                        <small><?php echo $this->lang->line('student1'); ?></small></h1>
                ...
                <aside class="studentsidebar">
                    <div class="stutop" id="">
                        ...
                        <div class="studentsidetopfixed">
                            <p class="classtap"><?php echo $student["class"]; ?>
                                <a href="#" data-toggle="control-sidebar" class="studentsideclose"><i class="fa fa-times"></i></a>
                            </p>
                            ...
                            <ul class="list-group list-group-unbordered">
                                ...
                                if ($student['is_active'] == 'no') {
                                    ...
                                    <li class="list-group-item listnoback">
                                        ...
                                        <span class="pull-right text-aqua"><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($student['disable_at'])); ?></span>
                                    </li>
                                ...
                                <li class="list-group-item listnoback">
                                    ...
                                    <a class="pull-right text-aqua"><?php echo $student['section']; ?>
                                    </a>
                                </li>

                                <li class="list-group-item listnoback">
                                    <b><?php echo $this->lang->line('gender'); ?></b>
                                    <a class="pull-right text-aqua"><?php echo $this->lang->line(strtolower($student['gender'])); ?>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="nav-tabs-custom theme-shadow">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#activity" data-toggle="tab"
                                                  aria-expanded="true"><?php echo $this->lang->line('profile'); ?></a>
                            </li>
                            ...
                            if ($this->module_lib->hasActive('fees_collection')) {
                                if (($this->rbac->hasPrivilege('collect_fees', 'can_view') ||
                                    ...
                                    <li class=""><a href="#fee" data-toggle="tab"
                                                    aria-expanded="true"><?php echo $this->lang->line('fees'); ?></a>
                                    </li>
                                    <?php
                                }
                            }
                            ...
                            <li><a href="#attachment" data-toggle="tab"
                                   aria-expanded="true"><?php echo $this->lang->line('attachment'); ?></a></li>
                            <?php
                            if ($this->rbac->hasPrivilege('student_timeline', 'can_add')) {
                                ?>
                                <li class=""><a href="#timelineh" data-toggle="tab"
                                                aria-expanded="true"><?php echo $this->lang->line('logbook_timeline') ?></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($sch_setting->upload_documents) {
                                ...
                                <li class=""><a href="#documents" data-toggle="tab"
                                                aria-expanded="true"><?php echo $this->lang->line('documents'); ?></a>
                                </li>
                                <?php
                            } ?>
...
//5235
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="activity">
                                ...
                                <div class="tshadow mb25 bozero">
                                    <h3 class="pagetitleh2"><?php echo $this->lang->line('insurance'); ?><?php echo $this->lang->line('detail'); ?></h3>
                                    <div class="table-responsive around10 pt0">
                                        <button type="button" class="btn btn-success pull-right mt10" data-toggle="modal" data-target="#insurance_modal">
                                            <i class="fa fa-plus"></i> Add Insurance
                                        </button>
                                        <table class="table table-hover table-striped tmb0">
                                            <tbody>
                                            <?php if(!empty($insurance)){
                                                foreach($insurance as $insura):
                                                    ?>
                                            <tr>
                                                <td class="col-md-4">Insurance Company</td>
                                                <td class="col-md-5"><?= $insura['insurance_company'];?></td>
                                                <td rowspan="4">
                                                    <?php  $docII = explode(".", $insura['insurance_image']);
                                                    if($docII[1] != 'png' || $docII[1] != 'jpeg' || $docII[1] != 'jpg'){ ?>
                                                        <a href="<?php echo base_url() .'uploads/student_documents/'.$student['id'].'/' .$insura["insurance_image"];?>">
                                                            <iframe class="profile-user-img img-responsive img-circle" src="<?php  echo base_url() .'uploads/student_documents/'.$student['id'].'/' .$insura["insurance_image"];?>">

                                                            </iframe>
                                                        </a>
                                                    <?php }else{?>
                                                        <img class="profile-user-img img-responsive img-circle" src="<?php
                                                        if (!empty($insura["insurance_image"])) {
                                                            echo base_url() .'uploads/student_documents/'.$student['id'].'/' .$insura["insurance_image"];
                                                        } else {
                                            ...
                                            <tr>
                                                <td>Policy Number</td>
                                                <td><?= $insura["policy_number"]; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Policy Expires on</td>
                                                <td>
                                                    <?php
                                                    $todayDate = date('m/d/Y');
                                                    if (!empty($insura["expires_on"]) && $insura["expires_on"]!='0000-00-00') {
                                                        $dateC = date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($insura["expires_on"]));
                                                        if($todayDate < $dateC){$badge = '<span class="badge badge-success">Active</span>';}else{$badge = '<span class="badge badge-danger">Inactive</span>';}
                                                        echo $dateC.'  '.$badge;
                                                    }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url(); ?>student/insurance_delete/<?php echo $insura['id'] . "/" . $insura['student_id']; ?>"
                                ...
                                <div class="tshadow mb25 bozero">
                                        ...
                                        <h3 class="pagetitleh2">Other Misc Details </h3>
                            ...
                            <div class="tab-pane" id="timelineh">
                                <div><?php if ($this->rbac->hasPrivilege('student_timeline', 'can_add')) { ?>
                                        <button type="button" id="myTimelineButton"
                                                class="btn btn-sm btn-primary pull-right"><i
                                                    class="fa fa-plus"></i> <?php echo $this->lang->line('add') ?>
                                        </button>
                            ...
                            <div class="tab-pane" id="attachment">
                                ...
                                <div class="table-responsive" style="clear: both;">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
                                        ...
                                        <tbody>
                                        <?php $count =0; foreach($attachment_list as $attachment): $count++;?>
                                        <tr>
                                            <td><?php echo $count; ?></td>
                                            <td><?php echo $attachment['company_name']; ?></td>
                                            <td><?php echo $attachment['start_date']; ?></td>
                                            <td><?php echo $attachment['end_date']; ?></td>
                                            <td>
                                                <?php

                                                if (!empty($attachment['start_date']) && $attachment['start_date']!='0000-00-00') {
                                                    $stringDate = strtotime($attachment['start_date']);
                                                    $attachmentDate = date('m/d/Y', $stringDate);
                                                    $todayDate = date('m/d/Y');
                                                    $endDate = strtotime($attachment['end_date']);
                                                    $endDate1 = date('m/d/Y',$endDate);

                                                    if($todayDate >= $attachmentDate && $todayDate <= $endDate1){
                                                        ?>
                                                        <span class="label label-success">Ongoing</span>
                                                        <?php
                                                    } else if($todayDate > $attachmentDate && $todayDate > $endDate1){ ?>
                                            ...
                                            <td class="pull-right">
                                                <a href="<?php echo base_url(); ?>attachment/view/<?php echo $attachment['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                    <i class="fa fa-reorder"></i>
                                                </a>

                                                    <a href="<?php echo base_url(); ?>attachment/edit/<?php echo $attachment['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="Edit">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>

                                                    <a href="<?php echo base_url(); ?>attachment/download/<?php echo $attachment['id'] ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Download Report">
                                                        <i class="fa fa-download"></i>
                                                    </a>
...
<!--attachment tab ends here-->
                            <div class="tab-pane" id="exam">
                                ...
                                <div class="dt-buttons btn-group pull-right miusDM40">
                                    <a class="btn btn-default btn-xs dt-button no_print" id="print"
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          ?>
                                                    ...
                                                    <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                                        <div class="description-block">
                                                            <h5 class="description-header"><?php echo $this->lang->line('grand') . " " . $this->lang->line('total') ?>
                                                                :
                                                                <span class="description-text"><?php echo $exam_grand_total; ?></span>
                                                            </h5>
                                                        </div>
                                                    </div>
                     ...
                     ?>
                                                ...
                                                <div class="col-sm-3 border-right no-print">
                                                    <div class="description-block"><h5
                                                                class="description-header"><?php echo $this->lang->line('total') . " " . $this->lang->line('obtain') . " " . $this->lang->line('marks'); ?>
                                                            :
                                                            <span class="description-text"><?php echo $exam_get_total; ?></span>
                                                        </h5>
                                                    </div>
                  ...
                  ?>
                                            ...
                                            if ($consolidate_exam_result_percentage) {
                                                ...
                                                <div class="col-sm-3 border-right no-print">
                                                    <div class="description-block">
                                                        <h5 class="description-header"><?php echo $this->lang->line('division'); ?>
                                                            :<span class="description-text">
                  <?php
                                    ...
                                    <div class=" col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="timeline_date"
                                                   ...
                                                   name="timeline_date" placeholder="" type="text"
                            ...
                            <form id="form1" action="<?php echo site_url('student/create_doc') ?>" id="employeeform"
                                ...
                                <div class="modal-body pt0 pb0">
                                    <div id='upload_documents_hide_show'>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><?php echo $this->lang->line('title'); ?>
    ...
    <div class="modal fade" id="insurance_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Insurance Data</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="form17" action="<?php echo site_url('student/create_insurance') ?>"
                          name="employeeform" method="post" accept-charset="utf-8"
                          enctype="multipart/form-data">
                        <?php echo $this->customlib->getCSRF(); ?>
                        <div class="modal-body pt0 pb0">
                            <div id='upload_documents_hide_show'>
                                ...
                                <h4><?php echo $this->lang->line('upload_documents1'); ?></h4>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Insurance Company Name
                                        <small class="req"> *</small></label>
                                    <input id="company_name" name="company_name" placeholder="" type="text"
                                           class="form-control"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Policy Details
                                        <small class="req"> *</small></label>
                                    <input id="policy_name" name="policy_name" placeholder="" type="text"
                                           class="form-control"
                                           value="<?php echo set_value('policy_name'); ?>"/>
                                    <span class="text-danger"><?php echo form_error('policy_name'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Policy Number
                                        <small class="req"> *</small></label>
                                    <input id="policy_number" name="policy_number" placeholder="" type="text"
                                           class="form-control"
                                           value="<?php echo set_value('policy_number'); ?>"/>
                                    <span class="text-danger"><?php echo form_error('policy_number'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Expires On
                                        <small class="req"> *</small></label>
                                    <input id="expires_on" name="expires_on" placeholder="" type="date"
                                           class="form-control"
                                           value="<?php echo set_value('expires_on'); ?>"/>
                                    <span class="text-danger"><?php echo form_error('expires_on'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('documents'); ?>
                                        <small class="req"> *</small></label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (e) {
            ...
            $("#form17").on('submit', (function (e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "<?php echo site_url("student/create_insurance") ?>",
                    type: "POST",
                    data: new FormData(this),
                    dataType: 'json',
                    contentType: false,
