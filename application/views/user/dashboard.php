            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#attachment_data" data-toggle="tab" aria-expanded="true">
                                <?php echo $this->lang->line('attachment'); ?></a>
                        </li>
                        <li class=""><a href="#timelineh" data-toggle="tab" aria-expanded="true">
                                <?php echo $this->lang->line('class_elogbook'); ?></a>
                        </li>
                                        ...
                                        <?php if ($sch_setting->student_email) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else { ?>
                                                        <span><button class="btn btn-xs btn-success">Verify Now</button></span>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php }?>
...
<!--                                        </tr>-->
                            ...
                            <div class="tshadow mb25 bozero">
                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <?php if(!empty($insurance)){  foreach($insurance as $insura):?>
                                            <tr>
                        ...
                        <div class="tab-pane" id="attachment_data">
                            <div class="timeline-header no-border">
                                <div class="header head-title">
                                    <button class="btn btn-xs btn-info pull-right m10" data-toggle="modal" data-target="#attachment_company_data">Add Industrial Attachment Place</button>
                                </div>
                                <div id="timeline_list">
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-striped table-bordered table-hover example">
                                            <?php
//                                            foreach($attachment_record as $rec):
                                                $attachmentStartDate = $attachment_record['start_date'];
                                                ?>
                                            <tr>
                                                <td>Company Name</td>
                                                <td><?php echo $attachment_record['company_name'];?></td>
                                                <td><i class="fa fa-pencil"></i></td>
                                            </tr>
                                            <tr>
                                                <td>Company Phone</td>
                                                <td><?= $attachment_record['company_phone'];?></td>
                                                <td><i class="fa fa-pencil"></i></td>

                                            </tr>
                                            <tr>
                                                <td>Company Address</td>
                                                <td><?= $attachment_record['company_address'];?></td>
                                                <td><i class="fa fa-pencil"></i></td>
                                            </tr>
                                            <tr>
                                                <td>County</td>
                                                <td><?php echo $attachment_record['county']; ?></td>
                                                <td><i class="fa fa-pencil"></i></td>
                                            </tr>
                                             <tr>
                                                <td>City</td>
                                                <td><?php echo $attachment_record['city']; ?></td>
                                                <td><i class="fa fa-pencil"></i></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                            ...
                                            <tr>
                                                <td>Attachment Start Date</td>
                                                <td><?= $attachment_record['start_date']; ?>
                                                    <?php

                                                    if (!empty($attachment_record['start_date']) && $attachment_record['start_date']!='0000-00-00') {
                                                        $stringDate = strtotime($attachment_record['start_date']);
                                                        $attachmentDate = date('m/d/Y', $stringDate);
                                                        $todayDate = date('m/d/Y');

                                                        if($todayDate >= $attachmentDate){
                                                           ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td rowspan="4" colspan="2">
                                                      <?php if(!empty($attachment_record['document'])){?>
                                                          <img src="<?php echo base_url().$attachment_record['document']; ?>" class="profile-user-img img-responsive img-circle"/>
                                                        <?php } else { ?>
                                                          <img src="<?php  echo base_url() . "uploads/student_images/no_image.png";?>" class="profile-user-img img-responsive img-circle">
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                        <?php //endforeach;?>
...
// Step 3: Creating the Date Range
                                       ...
                                       <ul class="timeline timeline-inverse">
                                           ...
                                           foreach($date_range as $date):
                                               ...
                                               $attachmentDate = date('m/d/Y', $stringStDate);
                                               ?>
                                           <li class="time-label">
                                               ...
                                               <div class="timeline-item">
                                                   ...
                                                   <div class="timeline-body">
                                                       <div class="form-group">
                                                           <textarea id="compose-textarea<?php echo $stringStDate; ?>" name="message<?php echo $stringStDate; ?>" class="form-control" style="height: 300px; background:#F0F0F0; border:0px;">
                        ...
                        <div class="tab-pane" id="exam">
                            ...
                            if (empty($exam_result)) {
                                ?>
                                <div class="alert alert-danger">
                                    <?php echo $this->lang->line('no_record_found'); ?> kkk
                                </div>
                                <?php
                            }
                            if (!empty($exam_result)) {
...
<div class="modal fade" id="attachment_company_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form17"   name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <?php echo $this->customlib->getCSRF(); ?>
                    <div class="modal-body pt0 pb0">
                        <div id='upload_documents_hide_show'>
                            <input type="hidden" name="student_id" value="<?php echo $student['id']; ?>"
                                   id="student_id">
                            <input value="<?php echo $this->setting_model->getCurrentAttachmentSessionID();?>" name="set_session_id" type="hidden">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Company/Institution Name
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Physical Address
                                    <small class="req"> *</small></label>
                                <input id="physical_address" name="physical_address" placeholder="" type="text"
                                       class="form-control"
                                       value="<?php echo set_value('physical_address'); ?>"/>
                                <span class="text-danger"><?php echo form_error('physical_address'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Phone Number
                                    <small class="req"> *</small></label>
                                <input id="phone_number" name="phone_number" placeholder="" type="text"
                                       class="form-control"
                                       value="<?php echo set_value('phone_number'); ?>"/>
                                <span class="text-danger"><?php echo form_error('phone_number'); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">County
                                    <small class="req"> *</small></label>
                                <select class="form-control select2-dropdown" name="county">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nearest City/Town
                                    <small class="req"> *</small></label>
                                <select class="form-control select2-dropdown" name="city">
                                    <option>Nairobi</option>
                            ...
                            <div class="form-group">
                                <label for="start_date">Attachment End Date</label>
                                <input class="form-control date" name="end_date">
                            </div>
                            <div class="form-group" id="map_selector">
                                <div id="map"></div>
                            </div>
<!--                            <div class="form-group">-->
...
<script type="text/javascript">
    ...
    $("#form17").on('submit', (function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "<?php echo site_url("user/user/create_attachment_firm") ?>",
            type: "POST",
            data: new FormData(this),
            dataType: 'json',
            contentType: false,
